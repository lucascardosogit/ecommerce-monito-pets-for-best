...
function App() {
  ...
  return (
    ...
    <main>
      <Hero />
      <Gallery id='pet-gallery-container' title={'Take a look at some of our pets'} description={'Whats new?'} buttonText={'View more'} buttonIcon={'/images/media-arrow.svg'} type='pets' />
